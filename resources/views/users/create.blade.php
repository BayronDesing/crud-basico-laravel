...
<nav class="navbar navbar-expand-lg bg-danger">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col ">
                <h2 class="text-danger text-center">Registrate</h2>
                <form action="{{ route('users.store') }}" method="post" class="d-flex flex-column justify-content-center align-items-center">
                    @csrf 
                    <div class="col-6">
                    ...
                    <input class="form-control" type="text" name="lastnames">
                    </div>
                    <div class="col-6">
